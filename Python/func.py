...
A leap year contains a leap day. In the Gregorian calendar, 3 conditions are used to identify leap years:
...
Given a year, determine whether is a leap year. If it is a leap year, return the Boolean True, otherwise return False
Write a function called is_leap(year) to do that.
